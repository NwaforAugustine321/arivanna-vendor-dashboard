...
export const WidgetChatBot = (props) => {
	...
	return (
		<>
			<div className={`${props.chatbotHide ? 'ps-chaticon-show' : 'ps-chaticon-hidden'} floating-chat`}>
				<i onClick={props.handleToggelChatbot} className={`${props.chatbotHide ? 'floating fa fa-comments' : ''} transition-smooth`}></i>
			</div>
				...
				<div className='ps-chatbot-form-container'>
					<Form
						...
						<div className='row'>
							...
							<div className='col-sm-12'>
								<div>
									<Form.Item
										...
										<Input type='text' placeholder='Email' onChange={(e) => setAddress(e.target.value)} />
									</Form.Item>
								</div>
							</div>
							<div className='col-sm-12'>
								<div>
									<Form.Item name='phone_no' className='ps-forced-margin'>
										<span style={{ color: 'red' }}>
							...
							<div className='col-sm-12'>
								<div>
									<Form.Item name='order_number' className='ps-forced-margin'>
										<span style={{ color: 'red' }}>
											{' '}
										...
										<Input.TextArea
											autoSize={true}
											placeholder='message'
											onChange={(e) => setOrderNumber(e.target.value)}></Input.TextArea>
									</Form.Item>
								</div>
							</div>
						</div>
