...
const StyleSheets = () => (
    <Head>
        ...
        <meta name="keywords" content="Arivanna, react, ecommerce, Template" />
        <meta
            name="description"
            content="Arivanna - React eCommerce Template"
        />
        <title>Arivanna | React eCommerce Admin Template</title>
        <link
