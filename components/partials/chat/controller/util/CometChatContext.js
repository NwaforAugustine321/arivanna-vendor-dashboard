...
export class CometChatContextProvider extends React.Component {
        ...
        this.state = {
            ...
            roles: {
                ...
                [CometChat.GROUP_MEMBER_SCOPE.PARTICIPANT]:
                    Translator.translate('PARTICIPANT', props.language),
            },
    ...
    checkIfDirectCallIsOngoing = () => {
        ...
        if (
            ...
            if (
                this.state.callInProgress.customData.sessionID ===
                this.state.item.guid
            ) {
